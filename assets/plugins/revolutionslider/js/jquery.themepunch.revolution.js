 ...
 (function ($, undefined) {
        ...
        if (opt.navigationType == "bullet") {
            ...
            if (opt.navigationArrows == "nexttobullets") {
                ...
                if (opt.navigationArrows == "verticalcentered") {
                    ...
                    la.css({
                        'position': 'absolute',
                        'left': Math.round((ldiff / 2)) + "px",
                        'top': Math.round((decorh / 2)) + "px"
                    });
                    ra.css({
                        'position': 'absolute',
                        'left': Math.round((opt.width - ra.outerWidth() + ldiff / 2)) + "px",
                        'top': Math.round((decorh / 2)) + "px"
                    });
                    try {
                        navb.css({
            ...
            if (opt.navigationType == "thumb") {
                ...
                if (opt.navigationArrows == "verticalcentered") {
                    ...
                    la.css({
                        'position': 'absolute',
                        'left': Math.round((ldiff / 2)) + "px",
                        'top': Math.round((cap.outerHeight() / 2)) + "px"
                    });
                    ra.css({
                        'position': 'absolute',
                        'left': Math.round((opt.width - ra.outerWidth() + ldiff / 2)) + "px",
    ...
    function prepareSlides(container, opt) {
        ...
        container.find('>ul:first >li').each(function (j) {
            ...
            if (li.data('link') != undefined) {
                ...
                if (link == "slide") li.append('<div class="tp-caption sft slidelink" data-x="0" data-y="0" data-linktoslide="' + linktoslide + '" data-start="0"><a><div></div></a></div>');
                else li.append('<div class="tp-caption sft slidelink" data-x="0" data-y="0" data-linktoslide="' + linktoslide + '" data-start="0"><a target="' + target + '" href="' + link + '"><div></div></a></div>');
    ...
    function setCaptionPositions(container, opt) {
        ...
        if (nextcaption.find('iframe') == 0) {
            ...
            if (nextcaption.hasClass('hcenter')) nextcaption.css({
    ...
    function swapSlide(container, opt) {
        ...
        if (nexttrans == 11) {
            ...
            nextsh.find('.slotslide').each(function (i) {
                var ss = $(this);
                ssamount++;
                if (opt.ie9 || opt.ie) ss.transition({
                    'opacity': 0
                }, 0);
                else ss.transition({
                    'opacity': 0,
        ...
        nextli.find('.tp-caption').each(function (i) {
            ...
            if (handlecaption == 0) {
                ...
                if (nextcaption.hasClass("randomrotate")) {
                    ...
                    if (opt.ie || opt.ie9) {} else nextcaption.transition({
                        scale: 1,
                        rotate: 0
                    });
                }
    ...
    function endMoveCaption(nextcaption, opt) {
        ...
        if (nextcaption.hasClass('ltr') || nextcaption.hasClass('ltl') || nextcaption.hasClass('str') || nextcaption.hasClass('stl') || nextcaption.hasClass('ltt') || nextcaption.hasClass('ltb') || nextcaption.hasClass('stt') || nextcaption.hasClass('stb')) {
            ...
            if (nextcaption.hasClass('ltr')) xx = opt.width + 20;
            else if (nextcaption.hasClass('ltl')) xx = 0 - nextcaption.width() - 20;
            else if (nextcaption.hasClass('ltt')) yy = 0 - nextcaption.height() - 20;
            else if (nextcaption.hasClass('ltb')) yy = opt.height + 20;
            ...
            if (nextcaption.hasClass('lfr')) xx = opt.width + 20;
            else if (nextcaption.hasClass('lfl')) xx = 0 - nextcaption.width() - 20;
            else if (nextcaption.hasClass('lft')) yy = 0 - nextcaption.height() - 20;
            else if (nextcaption.hasClass('lfb')) yy = opt.height + 20;
    ...
    function countDown(container, opt) {
        ...
        if (opt.slideamount > 1 && !(opt.stopAfterLoops == 0 && opt.stopAtSlide == 1)) {
            ...
            opt.cdint = setInterval(function () {
                ...
                if (opt.fullWidth != "on") if (opt.width > opt.hideSliderAtLimit) container.parent().removeClass("tp-hide-revslider")
